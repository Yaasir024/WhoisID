<template>
  <div
    class="bg-id-green-1 text-white px-[25px] sm:px-[40px] md:px-[69px] py-[40px] sm:py-[75px] md:py-[120px] max-h-[500px] rounded-3xl relative overflow-hidden"
  >
    ...
    <img
      ...
      alt=""
      class="hidden md:block absolute bottom-[0px] right-[0px] h-[430px] w-[520px]"
    />
  </div>
</template>
